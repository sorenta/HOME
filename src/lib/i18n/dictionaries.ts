...
> = {
  lv: {
    ...
    "reset.score": "Dienas spīdums",
    "reset.metrics": "Signāli no dienas",
    "reset.privacy": "Privātuma balanss",
    "reset.recommendation": "Mājas ieteikums",
    "reset.partnerAura": "Ārējais tēls",
    "reset.partnerAuraDemo": "Maiga",
    "reset.partnerAuraHint": "Redzams bez detaļām — partneris neredz skaitļus",
    "reset.aura.low": "Maigs",
    "reset.aura.steady": "Līdzsvarots",
    "reset.aura.high": "Spožs",
    ...
    "reset.privacyBody":
      "Partneris redz tikai spīduma līmeni un kopprocentu, nevis soļus, ekrānu vai privātās piezīmes.",
    "reset.seesAuraOnly": "redz tikai auru",
    "reset.seesGlowOnly": "redz tikai spīdumu",
    ...
    "reset.signals.intro":
      "Pēc H:0 RESET mērķa — soļi, ekrāna laiks un meditācija ietekmē tavu auru. Partneris šos skaitļus neredz; saglabāti tikai tavā Supabase kontā (RLS). Vēlāk var pieslēgt Health / sensorus.",
    ...
    "settings.privacy.resetAura": "Empātijas / spīduma kopīgošana",
  ...
  en: {
    ...
    "reset.score": "Daily glow",
    "reset.metrics": "Signals from your day",
    "reset.privacy": "Privacy balance",
    "reset.recommendation": "Home suggestion",
    "reset.partnerAura": "Outer tone",
    "reset.partnerAuraDemo": "Soft",
    "reset.partnerAuraHint": "Visible without raw numbers — partner does not see metrics",
    "reset.aura.low": "Soft",
    "reset.aura.steady": "Balanced",
    "reset.aura.high": "Bright",
    "reset.metric.goals": "Goals",
    "reset.metric.quit": "Quit goals",
    "reset.metric.body": "Body logs",
    "reset.metric.training": "Training modes",
    "reset.privacyBody":
      "Partners see only glow level and overall percent — not steps, screen time, or private notes.",
    "reset.seesAuraOnly": "sees aura only",
    "reset.seesGlowOnly": "sees glow only",
    "reset.checkin.limitHint":
    ...
    "reset.signals.intro":
      "Per H:0 RESET — steps, screen time, and meditation shape your aura. Your partner does not see these numbers; stored only in your Supabase account (RLS). Health / sensors can be wired later.",
    ...
    "settings.privacy.resetAura": "Share empathy / glow signals",
