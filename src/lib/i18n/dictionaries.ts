...
> = {
  lv: {
    ...
    "reset.signals.intro":
      "Pēc HOME:OS RESET mērķa — soļi, ekrāna laiks un meditācija ietekmē tavu auru. Partneris šos skaitļus neredz; saglabāti tikai tavā Supabase kontā (RLS). Vēlāk var pieslēgt Health / sensorus.",
    ...
    "reset.signals.mood": "Pašsajūta (1–5)",
  ...
  en: {
    ...
    "reset.signals.intro":
      "Per HOME:OS RESET — steps, screen time, and meditation shape your aura. Your partner does not see these numbers; stored only in your Supabase account (RLS). Health / sensors can be wired later.",
