...
export const THEMES: Record<ThemeId, ThemeManifestV2> = {
  ...
  botanical: {
    ...
    emoji: "🌿",
    colors: {
      /* 2026: Bio-digital — warmer parchment, deep moss, terracotta undertones, mycelium beige */
      background: "#EEE8D8",
      backgroundSecondary: "#E5DFC8",
      surface: "rgba(251,247,238,0.94)",
      surface2: "rgba(247,242,230,0.82)",
      card: "rgba(253,250,242,0.90)",
      cardElevated: "rgba(255,253,246,0.97)",
      textPrimary: "#1E2E18",
      textSecondary: "#3E5432",
      textMuted: "#5E7452",
      border: "rgba(62,84,50,0.18)",
      borderStrong: "rgba(62,84,50,0.32)",
      /* Deep moss — not flat green, has warmth */
      accent: "#3E6B32",
      accentHover: "#325A28",
      accentSoft: "rgba(62,107,50,0.16)",
      success: "#2D8C4E",
      warning: "#C2620A",
      danger: "#C0392B",
      info: "#1D6FA4",
      buttonPrimary: "#3E6B32",
      buttonPrimaryText: "#EEE8D8",
      buttonSecondary: "rgba(253,250,242,0.85)",
      buttonSecondaryText: "#1E2E18",
      inputBackground: "rgba(253,250,242,0.95)",
      inputBorder: "rgba(62,84,50,0.24)",
      focusRing: "rgba(62,107,50,0.45)",
      navBackground: "rgba(238,232,216,0.95)",
      navActive: "#3E6B32",
      navInactive: "#5E7452",
      heroGlow:
        "radial-gradient(ellipse 100% 60% at 50% -8%, rgba(100,140,85,0.24), transparent 52%), radial-gradient(circle at 85% 90%, rgba(160,120,60,0.10), transparent 35%)",
      panelShadow: "0 20px 50px rgba(30,46,24,0.12), inset 0 1px 0 rgba(255,255,255,0.50)",
      authBackground:
        "linear-gradient(180deg, #EEE8D8 0%, #E8E0C8 50%, #DED6BC 100%)",
      authCard: "rgba(253,250,242,0.94)",
      authBorder: "rgba(62,84,50,0.16)",
    },
    fonts: {
      ui: "var(--font-manrope)",
    ...
    ui: {
      backgroundImage:
        "radial-gradient(circle at 18% 14%, rgba(100,140,85,0.20), transparent 30%), radial-gradient(circle at 82% 22%, rgba(180,148,80,0.14), transparent 26%), radial-gradient(circle at 50% 95%, rgba(160,120,60,0.10), transparent 32%), linear-gradient(180deg, #EEE8D8 0%, #E5DFC8 55%, #D8D0B8 100%)",
      panelHighlight: "rgba(255,253,246,0.70)",
      tileShadow: "0 16px 40px rgba(30,46,24,0.09)",
      headerGlow: "rgba(62,107,50,0.14)",
      panelBorderStyle: "1px solid rgba(62,84,50,0.13)",
      tileBorderStyle: "1px solid rgba(62,84,50,0.10)",
      bodyOverlayStrength: 0.32,
    },
  },
  pulse: {
    id: "pulse",
