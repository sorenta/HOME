...
export const THEMES: Record<ThemeId, ThemeManifestV2> = {
  ...
  pulse: {
    ...
    colors: {
      background: "#F7F7F2",
      backgroundSecondary: "#EAEAE3",
      surface: "#FFFFFF",
      surface2: "#F0F0EA",
      card: "#FFFFFF",
      cardElevated: "#FFFFFF",
      textPrimary: "#2B2D42",
      textSecondary: "#4A4C61",
      textMuted: "#7A7C8F",
      border: "#2B2D42",
      borderStrong: "#2B2D42",
      accent: "#FF6B6B",
    ...
    ui: {
      backgroundImage:
        "radial-gradient(circle at 12% 20%, rgba(255,107,107,0.12), transparent 28%), radial-gradient(circle at 88% 12%, rgba(78,205,196,0.1), transparent 25%), linear-gradient(180deg, #F7F7F2, #EAEAE3)",
