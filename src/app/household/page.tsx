...
import { HouseholdThemeLayer } from "@/components/household/household-theme-layer";
...
function HouseholdPageInner() {
  ...
  return (
    <ModuleShell
      ...
      sectionId="household"
      description={t("household.page.description")}
    >
      <HouseholdThemeLayer>
        <HiddenSeasonalCollectible spotId="household" />
