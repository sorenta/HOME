...
export function HouseholdOnboarding({ compact = false }: Props) {
  ...
  return (
    <div
      className={[
        "rounded-3xl border border-[color:var(--color-surface-border)] bg-[color:var(--color-surface)] p-5",
        compact ? "" : "w-full",
      ].join(" ")}
    >
      ...
      <div className="mt-5 space-y-4">
        <div className="rounded-2xl border border-[color:var(--color-surface-border)] p-4">
          ...
          <button
            ...
            className={[
              ...
              loading !== null || !householdName.trim()
                ? "bg-[color:var(--color-surface-border)] text-[color:var(--color-secondary)]"
        ...
        <div className="rounded-2xl border border-[color:var(--color-surface-border)] p-4">
          ...
          {inviteCode ? (
            <p className="mt-2 text-xs text-[color:var(--color-secondary)]">
          ...
          <label className="mt-3 block text-sm text-[color:var(--color-text)]">
            ...
            <input
              ...
              className="mt-1 w-full rounded-xl border border-[color:var(--color-surface-border)] bg-transparent px-3 py-2 text-sm uppercase tracking-[0.18em]"
