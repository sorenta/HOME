...
export function PwaInstallPrompt() {
  ...
  return (
    <div className="fixed bottom-24 left-1/2 z-50 w-[calc(100%-1.5rem)] max-w-md -translate-x-1/2 rounded-2xl border border-[color:var(--color-surface-border)] bg-[color:var(--color-surface)]/95 p-4 shadow-lg backdrop-blur-md">
