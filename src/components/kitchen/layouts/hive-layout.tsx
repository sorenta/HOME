...
export function HiveKitchenLayout({
  normalInventory,
  urgentInventory,
  expiringToday,
  shopping,
  ...
  return (
    <div className="space-y-6">
      <div className="hive-amber relative overflow-hidden rounded-[20px] p-1">
        <KitchenHeader 
      ...
      {expiringToday.length > 0 && (
        <div className="maj-hive-metrics-honey p-4 bg-amber-500/10 border border-amber-500/20 rounded-[12px]">
          <div className="flex items-center gap-3">
            <span className="text-xl">🐝</span>
            <div className="flex-1">
              <p className="text-sm font-bold text-amber-900">
                {locale === "lv" ? "Aktuālās šūnas jāiztukšo!" : "Active cells must be emptied!"}
              </p>
            ...
            <button 
              ...
              className="px-4 py-1.5 text-[0.6rem] font-black uppercase tracking-widest bg-amber-600 text-white rounded-[8px] hover:bg-amber-700 transition-colors"
            >
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        <div className="maj-hive-hex-ambient opacity-10 pointer-events-none absolute inset-0 z-0" />
